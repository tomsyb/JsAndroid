...
public class V_WebViewProgressBar extends View {
    private int progress = 1;
    private final static int HEIGHT = 5;
    private Paint paint;
    private final static int colors[] = new int[]{};
    public V_WebViewProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public V_WebViewProgressBar(Context context) {
        super(context);
